...
enum class QuoteViewColorTheme(
  ...
  @AttrRes private val labelBackgroundColorRes: Int
) {
  ...
  INCOMING_WALLPAPER(
    ...
    R.attr.quote_view_label_background_incoming_wallpaper
  ),
  INCOMING_NORMAL(
    ...
    R.attr.quote_view_label_background_incoming_normal
  ),
  OUTGOING_WALLPAPER(
    ...
    R.attr.quote_view_label_background_outgoing_wallpaper
  ),
  OUTGOING_NORMAL(
    ...
    R.attr.quote_view_label_background_outgoing_normal
  );
  ...
  fun getLabelBackgroundColor(context: Context) = ThemeUtil.getThemedColor(context, labelBackgroundColorRes)
