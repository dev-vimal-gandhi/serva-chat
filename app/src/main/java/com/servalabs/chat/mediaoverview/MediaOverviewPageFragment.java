...
import com.servalabs.chat.core.util.ByteSize;
...
import com.servalabs.chat.database.loaders.GroupedThreadMediaLoader;
...
import com.servalabs.chat.util.BottomOffsetDecoration;
import com.servalabs.chat.util.CommunicationActions;
import com.servalabs.chat.util.OffloadedMediaDialogUtil;
  ...
  private void updateMultiSelect() {
    if (actionMode != null) {
      ...
      bottomActionBar.setItems(Arrays.asList(
          ...
          new ActionItem(com.servalabs.chat.core.ui.R.drawable.symbol_check_circle_24, getString(R.string.MediaOverviewActivity_select_all), this::handleSelectAllMedia),
          new ActionItem(com.servalabs.chat.core.ui.R.drawable.symbol_trash_24, getResources().getQuantityString(R.plurals.MediaOverviewActivity_delete_plural, selectionCount), this::handleDeleteSelectedMedia)
      ));
    }
  }
