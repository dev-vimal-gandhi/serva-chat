...
import com.servalabs.chat.archive.proto.AdminDeletedMessage
import com.servalabs.chat.archive.proto.ChatItem
import com.servalabs.chat.archive.proto.ChatUpdateMessage
import com.servalabs.chat.archive.proto.ContactAttachment
import com.servalabs.chat.archive.proto.ContactMessage
import com.servalabs.chat.archive.proto.DirectStoryReplyMessage
import com.servalabs.chat.archive.proto.ExpirationTimerChatUpdate
import com.servalabs.chat.archive.proto.GenericGroupUpdate
import com.servalabs.chat.archive.proto.GroupCall
...
import com.servalabs.chat.archive.proto.IndividualCall
import com.servalabs.chat.archive.proto.LearnedProfileChatUpdate
import com.servalabs.chat.archive.proto.MessageAttachment
import com.servalabs.chat.archive.proto.PinMessageUpdate
import com.servalabs.chat.archive.proto.Poll
import com.servalabs.chat.archive.proto.PollTerminateUpdate
import com.servalabs.chat.archive.proto.ProfileChangeChatUpdate
import com.servalabs.chat.archive.proto.Quote
import com.servalabs.chat.archive.proto.Reaction
import com.servalabs.chat.archive.proto.RemoteDeletedMessage
import com.servalabs.chat.archive.proto.SendStatus
import com.servalabs.chat.archive.proto.SessionSwitchoverChatUpdate
import com.servalabs.chat.archive.proto.SimpleChatUpdate
import com.servalabs.chat.archive.proto.StandardMessage
import com.servalabs.chat.archive.proto.Sticker
import com.servalabs.chat.archive.proto.StickerMessage
import com.servalabs.chat.archive.proto.Text
import com.servalabs.chat.archive.proto.ThreadMergeChatUpdate
import com.servalabs.chat.archive.proto.ViewOnceMessage
import com.servalabs.chat.core.models.ServiceId
import com.servalabs.chat.core.util.Base64
import com.servalabs.chat.core.util.EventTimer
import com.servalabs.chat.core.util.Hex
import com.servalabs.chat.core.util.ParallelEventTimer
...
import com.servalabs.chat.core.util.emptyIfNull
...
import com.servalabs.chat.core.util.nullIfEmpty
...
import com.servalabs.chat.backup.v2.util.toRemoteFilePointer
...
import com.servalabs.chat.archive.proto.BodyRange as BackupBodyRange
import com.servalabs.chat.archive.proto.GiftBadge as BackupGiftBadge
...
private fun LinkPreview.toRemoteLinkPreview(backupMode: BackupMode): com.servalabs.chat.archive.proto.LinkPreview {
  return com.servalabs.chat.archive.proto.LinkPreview(
    url = url,
