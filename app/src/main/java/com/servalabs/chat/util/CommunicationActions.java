...
import com.servalabs.chat.core.util.concurrent.JvmRxExtensions;
...
import com.servalabs.chat.groups.ui.invitesandrequests.joining.GroupJoinBottomSheetDialogFragment;
import com.servalabs.chat.groups.ui.invitesandrequests.joining.GroupJoinUpdateRequiredBottomSheetDialogFragment;
...
import com.servalabs.chat.profiles.manage.UsernameRepository.UsernameLinkConversionResult;
import com.servalabs.chat.recipients.Recipient;
import com.servalabs.chat.recipients.RecipientId;
import com.servalabs.chat.service.webrtc.ActiveCallData;
...
public class CommunicationActions {
  ...
  private static void startAudioCallInternal(@NonNull CallContext callContext, @NonNull Recipient recipient) {
    callContext.getPermissionsBuilder()
               ...
               .ifNecessary()
               .withRationaleDialog(callContext.getContext().getString(R.string.ConversationActivity_allow_access_microphone), callContext.getContext().getString(R.string.ConversationActivity__to_call_signal_needs_access_to_your_microphone), com.servalabs.chat.core.ui.R.drawable.symbol_phone_24)
