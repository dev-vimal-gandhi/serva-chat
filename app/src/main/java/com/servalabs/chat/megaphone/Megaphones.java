...
import com.servalabs.chat.core.util.MapUtil;
import com.servalabs.chat.core.util.SetUtil;
import com.servalabs.chat.core.util.TranslationDetection;
...
import com.servalabs.chat.lock.SignalPinReminderDialog;
import com.servalabs.chat.lock.SignalPinReminders;
import com.servalabs.chat.lock.v2.CreateSvrPinActivity;
import com.servalabs.chat.lock.v2.SvrMigrationActivity;
...
import com.servalabs.chat.profiles.username.NewWaysToConnectDialogFragment;
...
public final class Megaphones {
  ...
  private static boolean shouldShowEnableAppUpdatesMegaphone(@NonNull Context context) {
    return BuildConfig.MANAGE_MOLLY_UPDATES &&
