...
import com.servalabs.chat.components.BorderlessImageView;
import com.servalabs.chat.components.ConversationItemFooter;
import com.servalabs.chat.components.ConversationItemThumbnail;
...
import com.servalabs.chat.components.SharedContactView;
...
import com.servalabs.chat.conversation.clicklisteners.AttachmentCancelClickListener;
import com.servalabs.chat.conversation.clicklisteners.ResendClickListener;
...
import com.servalabs.chat.revealable.ViewOnceMessageView;
...
import com.servalabs.chat.util.views.NullableStub;
                                                                      ...
                                                                      InteractiveConversationElement
{
  ...
  private void setAudioViewTint(MessageRecord messageRecord) {
    if (hasAudio(messageRecord)) {
      if (!messageRecord.isOutgoing()) {
        ...
        audioViewStub.get().setProgressAndPlayBackgroundTint(getContext().getResources().getColor(com.servalabs.chat.core.ui.R.color.signal_colorTransparent2));
      }
    }
  }
   ...
   * Today this is only {@link com.servalabs.chat.conversation.quotes.MessageQuotesBottomSheet}.
   */
                                  ...
                                  boolean allowedToPlayInline)
  {
    ...
    if (isViewOnceMessage(messageRecord) && !messageRecord.isRemoteDelete()) {
      ...
      if (callLinkRootKey != null) {
        ...
        joinCallLinkStub.get().setTextColor(ThemeUtil.getThemedColor(context, messageRecord.isOutgoing() ? com.servalabs.chat.core.ui.R.color.signal_light_colorOnPrimary : com.google.android.material.R.attr.colorOnPrimaryContainer));
        joinCallLinkStub.get().setBackgroundColor(ThemeUtil.getThemedColor(context, messageRecord.isOutgoing() ? com.servalabs.chat.core.ui.R.color.signal_light_colorTransparent2 : com.google.android.material.R.attr.colorOnPrimary));
