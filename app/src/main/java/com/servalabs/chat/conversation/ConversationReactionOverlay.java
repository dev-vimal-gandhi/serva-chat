...
public final class ConversationReactionOverlay extends FrameLayout {
  ...
  private @NonNull List<ActionItem> getMenuActionItems(@NonNull ConversationMessage conversationMessage) {
    ...
    if (menuState.shouldShowEditAction()) {
      items.add(new ActionItem(com.servalabs.chat.core.ui.R.drawable.symbol_edit_24, getResources().getString(R.string.conversation_selection__menu_edit), () -> handleActionItemClicked(Action.EDIT)));
    }

    if (menuState.shouldShowForwardAction()) {
      items.add(new ActionItem(com.servalabs.chat.core.ui.R.drawable.symbol_forward_24, getResources().getString(R.string.conversation_selection__menu_forward), () -> handleActionItemClicked(Action.FORWARD)));
    }
    ...
    if (menuState.shouldShowCopyAction()) {
      items.add(new ActionItem(com.servalabs.chat.core.ui.R.drawable.symbol_copy_android_24, getResources().getString(R.string.conversation_selection__menu_copy), () -> handleActionItemClicked(Action.COPY)));
    }

    items.add(new ActionItem(com.servalabs.chat.core.ui.R.drawable.symbol_check_circle_24, getResources().getString(R.string.conversation_selection__menu_multi_select), () -> handleActionItemClicked(Action.MULTISELECT)));

    if (menuState.shouldShowDetailsAction()) {
      items.add(new ActionItem(com.servalabs.chat.core.ui.R.drawable.symbol_info_24, getResources().getString(R.string.conversation_selection__menu_message_details), () -> handleActionItemClicked(Action.VIEW_INFO)));
    }
    ...
    items.add(new ActionItem(com.servalabs.chat.core.ui.R.drawable.symbol_trash_24, getResources().getString(R.string.conversation_selection__menu_delete), () -> handleActionItemClicked(Action.DELETE)));
