...
import com.servalabs.chat.core.ui.permissions.PermissionDeniedBottomSheet
import com.servalabs.chat.core.ui.permissions.RationaleDialog
...
import com.servalabs.chat.components.settings.app.privacy.advanced.AdvancedPrivacySettingsRepository
  ...
  private fun getConfiguration(state: InternalSettingsState): DSLConfiguration {
    return configure {
      ...
      clickPref(
        ...
        summary = DSLSettingsText.from("Make as Serva never received the ping from ServaSocket. Will cause UnifiedPush to stop and Websocket to restart."),
        onClick = {
          MaterialAlertDialogBuilder(requireContext())
