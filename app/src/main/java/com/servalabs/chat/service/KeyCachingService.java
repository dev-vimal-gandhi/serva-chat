...
import com.servalabs.chat.devicetransfer.TransferStatus;
...
public class KeyCachingService extends Service {
  ...
  private void foregroundService() {
    ...
    builder.addAction(com.servalabs.chat.core.ui.R.drawable.symbol_lock_24, getString(R.string.KeyCachingService_lock), buildLockIntent());
