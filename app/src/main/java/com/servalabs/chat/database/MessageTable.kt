...
import com.servalabs.chat.core.util.SqlUtil.buildArgs
import com.servalabs.chat.core.util.SqlUtil.buildCustomCollectionQuery
import com.servalabs.chat.core.util.SqlUtil.buildSingleCollectionQuery
import com.servalabs.chat.core.util.SqlUtil.buildTrueUpdateQuery
import com.servalabs.chat.core.util.SqlUtil.getNextAutoIncrementId
import com.servalabs.chat.core.util.Stopwatch
import com.servalabs.chat.core.util.Util
import com.servalabs.chat.core.util.count
import com.servalabs.chat.core.util.delete
import com.servalabs.chat.core.util.deleteAll
import com.servalabs.chat.core.util.exists
...
import com.servalabs.chat.core.util.readToSet
import com.servalabs.chat.core.util.readToSingleBoolean
import com.servalabs.chat.core.util.readToSingleInt
import com.servalabs.chat.core.util.readToSingleLong
import com.servalabs.chat.core.util.readToSingleLongOrNull
import com.servalabs.chat.core.util.readToSingleObject
...
import com.servalabs.chat.attachments.DatabaseAttachment.DisplayOrderComparator
...
import com.servalabs.chat.database.EarlyDeliveryReceiptCache.Receipt
import com.servalabs.chat.database.MentionUtil.UpdatedBodyAndMentions
import com.servalabs.chat.database.SignalDatabase.Companion.attachments
import com.servalabs.chat.database.SignalDatabase.Companion.calls
import com.servalabs.chat.database.SignalDatabase.Companion.distributionLists
import com.servalabs.chat.database.SignalDatabase.Companion.groupReceipts
import com.servalabs.chat.database.SignalDatabase.Companion.groups
import com.servalabs.chat.database.SignalDatabase.Companion.mentions
import com.servalabs.chat.database.SignalDatabase.Companion.messages
import com.servalabs.chat.database.SignalDatabase.Companion.polls
import com.servalabs.chat.database.SignalDatabase.Companion.reactions
import com.servalabs.chat.database.SignalDatabase.Companion.recipients
import com.servalabs.chat.database.SignalDatabase.Companion.storySends
import com.servalabs.chat.database.SignalDatabase.Companion.threads
import com.servalabs.chat.database.documents.Document
...
import com.servalabs.chat.database.model.MessageExportStatus
...
import com.servalabs.chat.database.model.ParentStoryId.DirectReply
import com.servalabs.chat.database.model.ParentStoryId.GroupReply
import com.servalabs.chat.database.model.Quote
import com.servalabs.chat.database.model.StoryResult
import com.servalabs.chat.database.model.StoryType
import com.servalabs.chat.database.model.StoryType.Companion.fromCode
import com.servalabs.chat.database.model.StoryViewState
import com.servalabs.chat.database.model.databaseprotos.AdminDeleteStatus
...
import com.servalabs.chat.database.model.databaseprotos.MessageExportState
...
import com.servalabs.chat.jobs.TrimThreadJob
...
import com.servalabs.chat.util.isStory
...
open class MessageTable(context: Context?, databaseHelper: SignalDatabase) : DatabaseTable(context, databaseHelper), MessageTypes, RecipientIdDatabaseReference, ThreadIdDatabaseReference {
   ...
   *
   * Heavily lifted from [com.servalabs.chat.database.helpers.migration.V191_UniqueMessageMigrationV2].
   */
