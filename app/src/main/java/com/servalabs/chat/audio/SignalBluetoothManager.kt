 ...
 * reports that to the [com.servalabs.chat.webrtc.audio.SignalAudioManager], and then handles connecting/disconnecting
 * to the device if requested by [com.servalabs.chat.webrtc.audio.SignalAudioManager].
 */
