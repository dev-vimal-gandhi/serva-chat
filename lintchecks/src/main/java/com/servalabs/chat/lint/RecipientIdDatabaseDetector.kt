...
class RecipientIdDatabaseDetector : Detector(), SourceCodeScanner {
  ...
  override fun createUastHandler(context: JavaContext): UElementHandler {
    return object : UElementHandler() {
      override fun visitClass(node: UClass) {
        ...
        val implementsReference = node.interfaces.any { it.qualifiedName == "com.servalabs.chat.database.RecipientIdDatabaseReference" }
  ...
  companion object {
    ...
    private val EXEMPTED_CLASSES = setOf("com.servalabs.chat.database.RecipientDatabase")
  }
}