package com.servalabs.chat.core.ui.permissions;
...
import com.servalabs.chat.core.ui.R;
...
public class RationaleDialog {
  ...
  public static MaterialAlertDialogBuilder createFor(@NonNull Context context, @NonNull String title, @NonNull String details, @DrawableRes int... drawables) {
    ...
    for (int i = 0; i < drawables.length; i++) {
      ...
      DrawableCompat.setTint(drawable, ThemeUtil.getThemedColor(context, com.google.android.material.R.attr.colorOnPrimaryContainer));
